...
db_path = "/home/USER_HOME/AI-media-RC/backend/transcription/transcription.db"

# First stop the service so we don't fight over the WAL
import subprocess
subprocess.run(["bash", "/home/USER_HOME/AI-media-RC/scripts/watchdog.sh", "stop", "transcription"],
...
subprocess.run(["bash", "/home/USER_HOME/AI-media-RC/scripts/watchdog.sh", "restart", "transcription"],
               capture_output=True, timeout=10)
print("Done!")
